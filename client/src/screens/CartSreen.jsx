    ...
    <Wrap spacing="30px" justify="center" minHeight="100vh">
      {loading ? (
        ...
        <Alert status="warning">
          ...
          <AlertDescription><Link as={ReactLink} to='/products'>Click here to see products</Link></AlertDescription>
        </Alert>
      ) : (
        <Box px='4' py='8' w={{base: '95%', md: '70%', lg: '50%'}}>
          <Stack direction={{base: 'column', lg: 'row'}} align={{lg: 'flex-start'}} spacing={{base: '8', md: '16'}}>
            <Stack spacing={{base: '8', md: '10'}} flex='2'>
              <Heading fontSize='2xl' fontWeight='extrabold'>Shopping Cart</Heading>
              <Stack spacing='6'>
